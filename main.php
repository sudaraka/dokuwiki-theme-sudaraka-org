...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<aside id="div-sidebar" class="area">
			<div class="wrapper">
				...
				<div class="crl">
					...
					<p>Get the source code from <a target="_blank" href="https://gitorious.org/sudaraka-org/dokuwiki-theme">GIT repository</a>.</p>
		...
		<div class="hidden">
			...
			<?php /* <img src="http<?php echo (!empty($_SERVER['HTTPS']))?'s':''; ?>://nojsstats.appspot.com/UA-33560559-1/sudaraka.org<?php if(isset($_SERVER['HTTP_REFERER'])) { echo '?r=' . urlencode($_SERVER['HTTP_REFERER']); } ?>" alt="" width="1" height="1" /> */ ?>
		</div>
